  ...
  const handleCreateAppointment = useCallback(async () => {
    try {
      ...
      Alert.alert(
        ...
        'Ocorreu um erro ao tentar criar ao agendamento, tente novamente',
      );
    }
        ...
        <Schedule>
          ...
          <Section>
            ...
            <SectionContent horizontal>
              {morningAvaliability.map(({ hourFormatted, avaliable, hour }) => (
                <Hour
                  enabled={avaliable}
          ...
          <Section>
            ...
            <SectionContent horizontal>
              {afternoonAvaliability.map(
                ({ hourFormatted, avaliable, hour }) => (
                  <Hour
                    enabled={avaliable}
                    selected={selectedHour === hour}
                    avaliable={avaliable}
